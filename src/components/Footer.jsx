const Footer = () => {
  return (
    <footer className="md:px-[80px] px-4 w-full py-[100px] my-[100px] md:py-[150px] lg:my-[150px] gap-4 rounded-t-ml bg-[#004d40] rounded-t-3xl text-white flex flex-col text-center items-center ">
